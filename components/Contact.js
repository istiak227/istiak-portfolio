...
export default function Contact() {
  ...
  const subscribe = async (e) => {
    ...
    setForm({
      state: "success",
      message: `Thanks for dropping your email, I will get back to you ASAP`,
    });
  };

  return (
    <div className="border border-blue-200 rounded p-6 my-4 mb-10 w-full dark:border-gray-800 bg-blue-50 dark:bg-blue-opaque">
      <h5 className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100">
        Have an idea in mind? Let's discuss.
      </h5>
      <p className="my-1 text-gray-800 dark:text-gray-200">
        Drop your message and let's discuss about your project.
      </p>
      <a
        href="https://wa.me/+8801680173466?text=I want to work on a project with you"
      ...
      <form className="relative my-4" onSubmit={subscribe}>
        <input
          ...
          placeholder="istiak.ahmed227@gmail.com"
          type="email"
          autoComplete="email"
          required
